...
class LineNumberingTextArea extends JTextArea {
    ...
    public LineNumberingTextArea(JTextArea textArea) {
        ...
        setBackground(Color.LIGHT_GRAY);  // Background color for line numbers
...
public class NotepadApp extends JFrame implements ActionListener {
    ...
    JTextArea textArea;
    LineNumberingTextArea lineNumbers;
    //JCheckBoxMenuItem lineNumbersItem;
    ...
    JCheckBoxMenuItem darkModeItem, lineNumbersItem;
    ...
    public NotepadApp() {
        ...
        // Create View menu for Dark Mode, line Numbers
        ...
        lineNumbersItem.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == lineNumbersItem){
            if(lineNumbersItem.isSelected()){
